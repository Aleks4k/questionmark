...
public class CreateCommentDtoValidatorTests
{
    ...
    private readonly CreateCommentDtoValidator createCommentValidator;
    ...
    {
        createCommentValidator = new CreateCommentDtoValidator(_postRepo);
    ...
    public async Task Validate_ValidComment_ShouldHaveNoErrors()
    {
        ...
        var result = await createCommentValidator.TestValidateAsync(dto);
